...
#デブパレード #全ての武器をお箸に""",
    ...
    "x_naruto": f"""バッチコイ!!!も収録されます。

NARUTOのEDで流れたあの曲が、
2026年のDevparadeサウンドで蘇る。
...
#デブパレード #デブパレ #全ての武器をお箸に #新アルバム #トラックリスト公開 #バッチコイ #NARUTO #ロックバンド #8月19日 #拡散希望""",

    "tiktok_script": """【TikTok/Reels台本 (30秒)】
- BGM: バッチコイ!!!（イントロ）→ 夏の終わりに（サビ）→ 全ての武器をお箸に（ラスト）
- テロップ:
  0:00〜0:05: 「全10曲、全貌解禁」
  0:05〜0:10: 「NARUTOのバッチコイ!!!も収録」
  0:10〜0:15: 「先行シングル「夏の終わりに」も入ってる」
  0:15〜0:22: 「15年ぶり、デブたちの集大成」
  0:22〜0:28: 「1st Album「全ての武器をお箸に」」
  0:28〜0:30: 「8/19 リリース！」"""
}
