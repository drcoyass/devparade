...
TWEETS=(
"🍖【世界初】ポジデブBot、爆誕。SNS上の全ての「デブ」をポジティブに変換！全員90kg超のバンド DEV PARADEが全力で肯定します。試してみて👇 https://dev-parade.github.io/debu-bot.html #ポジデブBot #DEVPARADE"
...
"体重と幸福度は比例する。（DEV PARADE調べ）source: 俺たちメンバー全員90kg超で幸せ🍖 #ポジデブBot #DEVPARADE https://dev-parade.github.io/debu-bot.html"
