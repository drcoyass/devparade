...
THEME_MAPPINGS = {
    ...
    "meat_guitar_rocker.jpg": ["ロック", "ギター", "ライブ", "ステージ", "バンド", "シャウト", "骨付き肉", "90kg", "メジャー", "ugazin"],
    "burger_drummer_rocker.jpg": ["ハンバーガー", "バーガー", "ドラム", "ビート", "チーズ", "ファストフード", "ジャンク", "tah", "爆裂"],
    "pizza_surf_bassist.jpg": ["ピザ", "ベース", "スラップ", "グルーヴ", "低音", "重低音", "ぺー", "サーフィン"],
    "karaage_cheers_rocker.jpg": ["から揚げ", "唐揚げ", "ビール", "乾杯", "揚げ物", "宴会", "居酒屋", "ハイボール", "ゼロカロリー", "coyass", "判治", "笑顔"]
}
