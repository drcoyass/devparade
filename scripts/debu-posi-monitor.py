...
RESPONSES = {
    "デブ": [
        "デブ？ ありがとう！総体重全員90kg超バンドDEV PARADEから言わせてもらうと、それは最高の褒め言葉🍖 #ポジデブ",
        "「デブ」= Delightful Excellent Beautiful。知らなかった？🍖 by DEV PARADE #ポジデブ",
        "デブは才能。俺たち5人でメンバー全員90kg超、全員メジャーデビュー済み。才能に体重は関係ない🍖 #ポジデブ",
    ...
    "痩せ": [
        "痩せる必要？ ないね。俺たちメンバー全員90kg超で武道館目指してる。痩せたら夢が軽くなる💪🍖 #ポジデブ",
