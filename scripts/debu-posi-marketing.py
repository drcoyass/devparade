...
VIRAL_REPLIES = [
    "デブの話題が出たので来ました。総体重全員90kg超バンドのDEV PARADEです。デブは才能。🍖 #ポジデブBot",
    "デブをネガティブに語るスレッドに割り込む総体重全員90kg超バンドです。デブは最高。🍖 #ポジデブBot",
]
